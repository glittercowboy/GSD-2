...
export { resolveAgentEnd, resolveAgentEndCancelled, isSessionSwitchInFlight, _beginSessionSwitch, _endSessionSwitch, _hasPendingResolve, _resetPendingResolve, _setActiveSession } from "./auto/resolve.js";
